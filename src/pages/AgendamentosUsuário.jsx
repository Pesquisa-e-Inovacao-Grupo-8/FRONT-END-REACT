...
const SOCKET_URL = "http://renatatukotomi.duckdns.org:8088/ws-payment"; //rota do microservico
...
export default function AgendamentosUsuário() {
  ...
  async function gerarPagamento(id) {
    ...
    const response = await axios.post("http://renatatukotomi.duckdns.org:8088/flask-infinity-pay/create-checkout", payload);
